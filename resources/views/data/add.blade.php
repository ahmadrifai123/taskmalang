 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
       <form role="form" id="form" enctype="multipart/form-data" class="form-horizontal" method="POST" action="{{route('data.store')}}">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <select class="form-control " style="width: 100%;" name="gender" id="gender" required="">
                                    ...
                                    <option value="{{$gender_id}}">{{$gender_label}}</option>
                                    @endforeach
                                </select>
                 ...
                 <div class="box-footer">
                             <a  type="button" onclick="reset()" class="btn btn-default reset">Back</a>
