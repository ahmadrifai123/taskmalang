      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" role="form" method="POST" action="{{ route('data.store') }}">
              {{ csrf_field() }}
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="date" placeholder="nama" name="date">
                  </div>
                </div>
                 <div class="form-group">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post" action="{{url('data')}}" method="POST">
